...
import 'package:general_knowledge/ExampleWidgetBottomNavigationBar/React Native/quiz_brain.dart';
import 'package:google_fonts/google_fonts.dart';

QuizBrain quizBrain = QuizBrain();

class Quizzler11 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.black,
          title: Center(child: Text("React Native Programming Quiz",style: GoogleFonts.sourceSansPro(
            color: Colors.white,
