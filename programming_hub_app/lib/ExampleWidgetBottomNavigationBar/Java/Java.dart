...
import 'package:general_knowledge/ExampleWidgetBottomNavigationBar/Java/quiz_brain.dart';
import 'package:google_fonts/google_fonts.dart';

QuizBrain quizBrain = QuizBrain();

class Quizzler6 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.black,
          title: Center(child: Text("Java Programming Quiz",style: GoogleFonts.sourceSansPro(
            color: Colors.white,
